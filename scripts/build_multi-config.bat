...
:: Detect Conan profile and install dependencies for BOTH BUILDS
conan profile detect --force
conan install . --build=missing --settings=build_type=Release --settings=compiler.runtime=static --settings=compiler.cppstd=20
...
:: Switch to build directory and run CMake configuration for BOTH BUILDS
cd build
